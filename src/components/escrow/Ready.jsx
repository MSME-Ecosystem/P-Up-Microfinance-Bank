        ...
        <div className="flex flex-col lg:h-[500px] lg:justify-between">
          <div>
            ...
            <h1 className="font-[700] lg:text-[40px] text-[30px] leading-12 text-left">
              Make every cashier accountable — without
              slowing down operations.
            </h1>
            <p className="text-[16px] lg:w-[510px] mt-8 text-left">
              Whether it’s a busy supermarket or a mobile agent, SafeHands gives you full visibility into who collected what, where, and when. </p>
          </div>

          <div className="lg:flex lg:w-[48%] gap-10  mt-12  mb-10 z-10">
            <div className=" mb-5 lg:mb-0">
              <h4 className="lg:text-[22px] text-[24px] font-[700]">Cashier-Level Wallets</h4>
            ...
            <div className="">
              <h4 className="lg:text-[22px] text-[24px] font-[700]">Shift-Based Logs</h4>
              <p className="lg:mt-5 mt-2 text-[16px]">
                Understand who handled what — and when.
              </p>
            </div>{" "}
          </div>
        </div>
