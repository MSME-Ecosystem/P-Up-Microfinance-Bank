...
export function Footer() {
  const usecaseLinks = [
    ...
    { name: "Wallets & Escrow", href: "/wallets&escrow" },
  ...
  return (
    <footer className="bg-white text-black lg:pt-24 lg:pb-12">
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-[#000000] text-center mb-4">Contact sales</p>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0 mt-20">
          <div className="flex flex-col sm:flex-row items-center lg:text-end text-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-gray-400">
            <p>
              © {new Date().getFullYear()} 2025 P-UP Copyright{" "}
