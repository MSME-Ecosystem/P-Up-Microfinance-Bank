...
const Everything = () => {
  return (
    <div className="text-[#000000] py-28">
      ...
      <div className="bg-[#0171DF0D] border-[0.5px] border-[#0000001A] rounded-md lg:flex lg:flex-row flex-col lg:gap-[70px] gap-5 items-center justify-center lg:px-3 px-2 py-10">
        <div>
          <Image
            src={"/everything1.svg"}
            alt="Everything"
      ...
      <div className="bg-[#0171DF0D] border-[0.5px] border-[#0000001A] rounded-md lg:flex lg:flex-row flex-col lg:gap-[70px] gap-5 items-center justify-center lg:px-3 px-2 py-10 mt-10">
        <div>
