        ...
        <div className="lg:flex block justify-center gap-12">
          <div className="lg:h-[550px] h-auto flex flex-col justify-center lg:w-[520px] w-auto">
            <p className=" lg:text-[48px] text-[31px] font-[700] lg:leading-14 leading-8 lg:text-left text-center ">
              Streamline Payment Matching with{" "}
              <span className="text-[#0171DF]">ReconcileX</span>{" "}
            </p>
            <p className="py-8 text-[#1B1B1B] lg:text-left text-center lg:w-[374px] w-auto text-[14px]">
            ReconcileX automates the matching of payments to invoices, orders, and ledgers. Whether online or offline, it optimizes your financial processes seamlessly!
            </p>
