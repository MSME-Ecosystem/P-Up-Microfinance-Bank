        ...
        <div className="flex flex-col lg:h-[500px] lg:justify-between">
          <div>
            ...
            <h1 className="font-[700] lg:text-[40px] text-[30px] leading-12 text-left">
              Built for Collaborative <br />Commerce
            </h1>
          ...
          <div className="lg:flex  gap-10  mt-12  mb-20 z-10">
            <div className=" mb-5 lg:mb-0">
              <h4 className="lg:text-[22px] text-[24px] font-[700]">No missed commissions</h4>
            ...
            <div className="">
              <h4 className="lg:text-[22px] text-[24px] font-[700]">Reduce cart friction</h4>
              <p className="lg:mt-5 mt-2 text-[16px]">
