    ...
    <div className="bg-[#EFFAF8] h-auto relative mb-28  overflow-hidden lg:py-10 pt-10 lg:mt-30 mt-20">
      <div className="flex lg:px-40 px-5  ">
        <div className=" ">
          ...
          <Button
            asChild
            className="bg-[#0171DF] text-white h-11 lg:px-4 my-10 font-bold rounded-[5px] lg:w-auto w-full"
          >
            ...
            <div className="lg:flex block lg:w-[80%] w-full">
              <div className="flex-1 ">
                <p className="text-[#1B1B1B]">
                  <span className="text-black font-bold">Sandra, </span> a buyer
                  in Lagos, visits an Instagram page selling groceries. She
                  selects 3 items
                </p>
                <ul className="list-disc space-y-0 pl-8 pt-1">
                  <li>Rice from ObinnaRiceHub</li>
                  <li>Groundnut oil from MamaFatimaStores</li>
                  <li>Detergent from EkitiMarture, </li>
                </ul>
              </div>
              ...
              <div className="flex-1 ">
                <div className="bg-[#E6F7F1] rounded-[10px] m-auto p-5 w-full lg:w-[370px] text-[#1B1B1B]">
                  <p>
                    Each merchant has a P-UP merchant profile linked to UniTap.
                    Sandra adds all items to a single cart and checks out via
                    her mobile wallet. Behind the scenes, the system
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className=" lg:mt-20 mt-5">
              ...
              <div className="bg-[#E6F7F1] rounded-[10px]  p-5 w-full lg:w-[35%]">
                <ul className="list-disc px-6 space-y-4 pt-5 text-[14px]">
                  ...
                  <li>Reconciles each order independently </li>
