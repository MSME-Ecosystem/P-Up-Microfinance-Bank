    ...
    <div className="space-y-20">
      ...
      <div className="lg:flex lg:flex-row flex-col-reverse items-center justify-center lg:gap-[150px]">
        ...
        <div className="lg:text-left text-center">
          ...
          <h1 className="lg:text-[32px] text-[25px] font-bold text-[#0171DF] my-2 lg:my-5 lg:w-[462px] w-auto">
          All payment types. One smooth experience          </h1>
          <p className="lg:w-[462px] w-auto lg:leading-7">
          Accept cards, transfers, and digital wallets in a unified checkout optimized for how buyers want to pay.
          </p>
          <Button
            asChild
            className="bg-[#0F226B] text-white h-11 mt-5 lg:mt-10 w-full font-bold "
